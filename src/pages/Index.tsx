...
export default function Index() {
  ...
  useEffect(() => {
    Promise.all([dataClient.getAbout(), dataClient.getResume()]).then(([aboutData, resumeData]) => {
      setAbout(aboutData);
      ...
      <section className="py-16 bg-secondary/30">
        <div className="container">
          <div className="grid md:grid-cols-3 gap-8">
            <Link
              to="/skills"
              className="group p-8 bg-card rounded-xl border shadow-sm card-hover"
            >
              ...
              <p className="text-muted-foreground">
                Explore my technical skills across frontend, backend, and more.
              </p>
            </Link>
            ...
            >
              ...
              <p className="text-muted-foreground">
                View my recent projects and case studies.
              </p>
            </Link>
          </div>
        </div>
